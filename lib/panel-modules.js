...
const PANEL_MODULES = [
  ...
  { key: 'taxes', group: 'accounts', href: '/accounts/taxes', label: 'Tax rules', tileLabel: 'Tax rules', note: 'Dated tax rules with route bands and service exemptions, plus a calculator for what a rule change costs. The Bangladesh-specific half of compliance.' },
  { key: 'contracts', group: 'accounts', href: '/accounts/contracts', label: 'Contracts', tileLabel: 'Carrier contracts', note: 'Commission each airline allows, with effective dates, and a calculator for what a rate would be worth. Off for an agency that buys only net fares.' },
  { key: 'bsp', group: 'accounts', href: '/accounts/bsp', label: 'BSP', tileLabel: 'BSP reconciliation', note: 'Match the IATA billing file against the book at document level before the remittance date. Off for an agency that is not IATA-accredited.' },
  ...
  { key: 'reconcile', group: 'accounts', href: '/accounts/reconcile', label: 'Reconcile', tileLabel: 'Bank reconciliation', note: 'The bank statement against the book, item by item. Off for an agency whose accountant reconciles outside the system.' },
  { key: 'journal', group: 'accounts', href: '/accounts/journal', label: 'Journal', tileLabel: 'Journal vouchers', note: 'Manual double-entry: depreciation, accruals, prepayments, corrections and opening balances. Off for an agency whose accountant posts adjustments elsewhere.' },
